...
def train_and_validate(class_dirs, model_path, save_path, num_epochs, device, log_method):
    ...
    for epoch in range(num_epochs):
        ...
        log_method(f"Epoch {epoch+1}/{num_epochs}, Training Loss: {avg_train_loss}\n")
        
        val_loss = evaluate_model(model, val_loader, criterion, device)
        log_method(f"Epoch {epoch+1}/{num_epochs}, Validation Loss: {val_loss}\n")
